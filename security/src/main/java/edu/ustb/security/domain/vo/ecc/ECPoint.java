...
import edu.ustb.security.domain.vo.ecc.elliptic.NotOnMotherException;
...
public class ECPoint implements Serializable {
     ...
     * @throws throws a NotOnMotherException if (x,y) is not on the mother curve.
     */
...
//	if (!mother.onCurve(this)) throw new NotOnMotherException(this);
     ...
     * @throws throws a NoCommonMotherException if the two points don't lie on the same elliptic curve.
     */
